...
> ***Note:*** 
*If you don't have it, [Dowload here](https://www.python.org/downloads/).*

- **Java**: Make sure Java version 8 or above installed, and its directory is specified in the JAVA_HOME environment variable.
> ***Note:*** 
*If you don't have it, [Dowload here](https://adoptium.net/).*

- **Allure Commandline**: To see the beautiful test reports.
> ***Note:*** 
*If you don't have it, please follow the [Official Install Guide here](https://allurereport.org/docs/v2/install/).*
...
```
> ***Note:*** 
*All settings (browser, video, screenshots, reports) are already configured in the **pytest.ini** file. Commented commands are to debug, if you need any of them, press `Ctrl + /` it.*
